...
​	青训营的课程节奏比较快，不过有了其他语言的基础学习go语言还是比较容易的，第一天学习了go的语言特性，基础语法，并用go语言开发了三个小工程，凸显了go语言使用的场景，对于go语言有丰富的标准库，完善的工具链，高性能，高并发的的特性。小工程代码量不多的情况下实现了很实用的功能。相比于其他语言有很多实用函数需要学习，也可以更好面对很多应用场景，所以学习难度也会加大，需要多敲代码熟悉语言功能。
