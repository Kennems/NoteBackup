...
description : "set(handles.g1, 'Visible', 'on');"
image : img/cat.jpg
draft : false
categories : ["Matlab"]
tags : ["学习笔记", "Matlab"]
...
```
                ...
                app.Label_searchWindowSize.Text = {'邻域大小:'};
