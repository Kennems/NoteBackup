---
title : 'MIT6.S081(14)-File System'
date : 2024-10-04T19:30:13+08:00
lastmod: 2024-10-04T19:20:13+08:00
description : "MIT6.S081(14)-File System" 
categories : ["操作系统"]
tags : ["MIT6.S081"]
---

# MIT6.S081(14)-File System
...
| ------------------ | ---------------------------- | -------------------------- |
| **链接目标**       | 文件数据块（inode）          | 文件路径                   |
| **inode**          | 相同 inode                   | 不同 inode                 |
| **跨文件系统**     | 不允许                       | 允许                       |
| **链接目录**       | 不允许                       | 允许                       |
| **原始文件删除后** | 数据仍然存在，文件可用       | 软链接失效，成为“死链”     |
| **性能**           | 访问效率高，直接指向文件数据 | 需要通过路径查找，访问略慢 |
