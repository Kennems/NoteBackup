...
lastmod: 2026-05-04T14:12:20+08:00
description : "- Myeclipse （jdk+tomcat9)"
image : img/cat.jpg
draft : false
categories : ["电子课程"]
tags : ["学习笔记", "电子课程"]
...
<!-- 					get和post区别：get方式参数串附在网址后面，而post的参数串放在请求体（body）中发送。 -->
			<input> 
<!-- 				表单中的输入字段 -->
<!-- 				Text 单行文本框， -->
