...
description : "1. **Window 类**：负责在 `Activity` 中展示内容（具体实现为 `PhoneWindow` 类）"
image : img/cat.jpg
draft : false
categories : ["Android"]
tags : ["学习笔记", "Android", "训练营", "Day8"]
---
# 第八天笔记
...
![image-20240713160558214](https://cdn.jsdelivr.net/gh/kennems/blog-image/image-20240713160558214.png)